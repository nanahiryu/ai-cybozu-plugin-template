 ...
 *
 * 例:
 *   pnpm exec tsx .claude/skills/create-spec/scripts/get-form-fields.ts 123
 */
...
(async () => {
  try {
    ...
    if (!appId) {
      console.error("使用方法: pnpm exec tsx .claude/skills/create-spec/scripts/get-form-fields.ts <appId>");
      console.error("例: pnpm exec tsx .claude/skills/create-spec/scripts/get-form-fields.ts 123");
      process.exit(1);
    }
